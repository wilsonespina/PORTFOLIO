          ...
          <div className="container">
            ...
            <div className="picture-project-series container-fluid">
              <LazyLoad height={500} throttle={300} scroll={true} resize={true}>
                <a href="https://portfolio-project-4.herokuapp.com/" target="blank"><img src="../../assets/project_images/screenshot_landing.jpg" alt="project4-img1" className="project-images-screenshots" /></a>
              </LazyLoad>
            </div>
            <div className="picture-project-series container-fluid">
              <LazyLoad height={500} throttle={300} scroll={true} resize={true}>
                <a href="https://portfolio-project-4.herokuapp.com/" target="blank"><img src="../../assets/project_images/screenshot_profile.png" alt="project4-img2" className="project-images-screenshots" /></a>
              </LazyLoad>
            </div>
            <div className="picture-project-series container-fluid">
              <LazyLoad height={500} throttle={300} scroll={true} resize={true}>
                <a href="https://portfolio-project-4.herokuapp.com/" target="blank"><img src="../../assets/project_images/screenshot_usersshow.png" alt="project4-img3" className="project-images-screenshots" /></a>
              </LazyLoad>
            </div>
            <div className="picture-project-series container-fluid">
              <LazyLoad height={500} throttle={300} scroll={true} resize={true}>
                <a href="https://portfolio-project-4.herokuapp.com/" target="blank"><img src="../../assets/project_images/screenshot_comments_rating.jpg" alt="project4-img4" className="project-images-screenshots" /></a>
              </LazyLoad>
            </div>
